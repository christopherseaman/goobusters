...
# Configuration
# Read simulator from dot.yaml, fallback to default
SIMULATOR_NAME=$(uv run python3 -c "import yaml; print(yaml.safe_load(open('dot.yaml'))['ios']['simulator'])" 2>/dev/null || echo "iPad Air 11-inch (M3)")
